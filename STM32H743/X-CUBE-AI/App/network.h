...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "voiceprint_model"
...
#define AI_NETWORK_IN_1_HEIGHT      (39)
#define AI_NETWORK_IN_1_WIDTH       (94)
#define AI_NETWORK_IN_1_CHANNEL     (1)
#define AI_NETWORK_IN_1_SIZE        (3666)
#define AI_NETWORK_IN_1_SIZE_BYTES  (3666)
...
#define AI_NETWORK_OUT_1_SIZE_BYTES  (128)
